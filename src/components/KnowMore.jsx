...
const KnowMore = () => {
  ...
  return (
    <div>
      <div className="w-full  md:h-screen gap-5 md:gap-0  flex-col flex items-center justify-evenly px-5 md:px-32 py-10 md:py-0">
        <p className=" spectral-extralight-italic capitalize text-[#6d1d45] italic text-3xl md:text-6xl ">
          Know More
        </p>
          ...
          {cards.map((item, i) => (
            <div key={i} className="w-full h-full ">
              ...
              <div className="w-full pt-1 md:pt-5  flex items-center justify-start md:justify-center  md:text-center ">
                <a href={item.link}>
                  <p className=" opacity-80 text-base md:text-2xl   capitalize text-[#6d1d45]">
                    {item.name}
                  </p>
                </a>
              </div>
